...
struct RedArchiveFile {
    ...
    bool compressed;
    WolvenEngine::File::Compression compressionType;
...
public:
    ...
    {
        oo2 = LoadLibrary("oo2ext_7_win64.dll");
        assert(oo2 != 0);
        if (!oo2) return;
...
public:
    ...
    RedArchiveFile GetFile(uint32_t file_index)
    {
        ...
        WolvenEngine::File::Compression compressionType = WolvenEngine::File::Compression::NONE;
        ...
        for (uint32_t seg_index = fentry.segmentsStart; seg_index < fentry.segmentsEnd; seg_index++)
        {
            ...
            case 'ZLIB':
            {
                compressionType = WolvenEngine::File::Compression::ZLIB;
                is_compressed = true;
        ...
        return {f, dep, fentry, is_compressed, compressionType};
    }
